...
extension Q2er {
	internal func generateTicketEmailInternal(v: Verwaltung, ao: AktionObserver? = nil) -> Mail? {
		...
		let alternativeText = """
  Dein Email-Program unterstützt diese Email nicht. Bitte wende dich an Benedict.
  """
...
<br>
Bitte denk daran, dass auf dem Gelände der <a style="color: #0082ED" href="">  </a> die <a style="color: #0082ED" href="/de/meta-pages/hausordnung/">Hausordnung</a> gilt und wir uns dementsprechend verhalten müssen.
