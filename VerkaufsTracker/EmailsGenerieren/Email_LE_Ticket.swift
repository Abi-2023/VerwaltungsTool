		...
		<img height="auto" src="\(EmailManager.headerImage)" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="100" />
					...
					<tr>
					  <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
						<div style="font-family:Helvetica;font-size:19px;font-weight:bold;line-height:1;text-align:left;color:#FFE81F;">Sehr geehrte/Sehr geehrter \(name),</div>
					  </td>
					</tr>
					<tr>
					  <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
						<div style="font-family:Helvetica;font-size:16px;line-height:1;text-align:left;color:white;">Ihre Zahlung für die Abi-Feierlichkeiten ist bei uns eingegangen. <br></br>Hiermit senden wir Ihnen ihre Tickets für den Abiball und die anschließende After-Show-Party. \(extraText) <br></br> Bitte beachten Sie, das jedes Ticket am Abend des Abiballs nur einmal eingelöst werden kann. Die Tickets sind nummeriert, damit Sie diese nicht verwechselst. <br></br> Der Abiball findet am Dienstag, den 21.06.2023 in der <a style="color: #0082ED" href="***REMOVED***">***REMOVED*** ***REMOVED*** ***REMOVED***</a> statt. Der Einlass beginnt um 16:30. <br></br> Bitte denken Sie daran, dass auf dem Gelände der ***REMOVED*** die <a style="color: #0082ED" href="***REMOVED***/de/meta-pages/hausordnung/">Hausordnung</a> gilt. <br></br> Wir bedanken uns für Ihre Unterstützung und wünschen Ihnen einen schönen Abiball. <br></br>Viele Grüße,<br></br> Die Q2</div>
					  </td>
					</tr>
					<tr>
					  <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
