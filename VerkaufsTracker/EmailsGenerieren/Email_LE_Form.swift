...
extension Lehrer {
	internal func generateFormEmailInternal(ao: AktionObserver? = nil) -> Mail? {
		...
		let formUrl = "viewform?usp=pp_url&entry.514969491=\(formID)&entry.843812046=\(formName)&entry.827820194=0&entry.1757090896=0&entry.1728612605=0&entry.1468053126=0&entry.299688454=0"
