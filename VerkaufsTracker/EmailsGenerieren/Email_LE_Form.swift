...
Sehr geehrte/Sehr geehrter \(name),
   ...
   ⁃ Abipullis (ca. 25-40€ pro Stück)<br></br>
   Sie sich gerne wünschen.<br></br>

	</div></td></tr><tr> <td align="center" vertical-align="middle" style="font-size:0px;padding:10px 25px;word-break:break-word;"> <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;"> <tr> <td align="center" bgcolor="#FEE738" role="presentation" style="border:none;border-radius:3px;cursor:auto;mso-padding-alt:10px 25px;background:#FEE738;" valign="middle"> <a href="\(formUrl)" style="display:inline-block;background:#FFD900;color:black;font-family:Helvetica;font-size:16px;font-weight:normal;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:3px;" target="_blank"> <b>Bestellung eintragen</b> </a> </td></tr></table> </td></tr><tr> <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;"> <div style="font-family:helvetica;font-size:16px;line-height:1;text-align:left;color:white;">

Die Abgabefrist ist am Mittwoch, den 15.02.2023. Falls Sie bis dahin Ihre Meinung ändern sollten und eine Änderung vornehmen möchten, können Sie über den Link das Formular erneut ausfüllen. Nachdem wir die Wünsche von allen Schüler*innen und Lehrer*innen erfasst haben, können wir die Festpreise kalkulieren und Ihnen Informationen über den Bezahlungsvorgang schicken.<br></br> Bei Rückfragen können Sie sich gerne an folgende E-Mail-Adresse wenden: \(SECRETS.EMAIL_Address) <br></br> <br></br> Viele Grüße, <br>Die Q2
