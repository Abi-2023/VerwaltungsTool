...
extension Lehrer {
  ...
  <tr>
   ...
   <th style="padding: 0 0 0 15px;"align="right">\(Person.preisFuerItem(item: itemType, count: value).geldStr)</th>
  </tr>
  """
