...
struct TicketRenderer_Previews: PreviewProvider {
	...
	static var previews: some View {
		TicketRenderer(ticket: Ticket(owner: Q2er(vorname: "Benedict", nachname: "***REMOVED***", email: "benedicts@icloud,com", notes: "", bestellungen: [:], extraFields: [:], verwaltung: Verwaltung())))
